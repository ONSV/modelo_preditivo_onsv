...
Em razão da indisponibilidade de dados, os modelos confeccionados em geral contemplam uma janela de tempo de 2011 até a atualidade (2024), sendo as principais unidades de tempo estudadas a anual, trimestral e mensal. Ao criar modelos de série temporal, deve-se notar que a abundância de dados a serem modelados tem uma relação direta com a capacidade do modelo de aprender e conseguir expressá-los em instantes futuros.
...
pred_list <- list(
  ...
  summarise(
    mutate(pred_trimestre_2024, ano = year(data)),
    .by = ano,
  ...
  summarise(
    mutate(pred_mensal_2024, ano = year(data)),
    .by = ano,
